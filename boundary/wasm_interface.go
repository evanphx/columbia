...
func (w *WasmInterface) syscall0(ctx context.Context, idx int32) int32 {
	...
	w.L.Trace("syscall/ent", "pid", p.Pid, "index", idx, "name", syscalls.SyscallNames[idx])
...
func (w *WasmInterface) syscall1(ctx context.Context, idx, a int32) int32 {
	...
	w.L.Trace("syscall/ent", "pid", p.Pid, "index", idx, "name", syscalls.SyscallNames[idx], "a", a)
...
func (w *WasmInterface) syscall2(ctx context.Context, idx, a, b int32) int32 {
	...
	w.L.Trace("syscall/ent", "pid", p.Pid, "index", idx, "name", syscalls.SyscallNames[idx], "a", a, "b", b)
...
func (w *WasmInterface) syscall3(ctx context.Context, idx, a, b, c int32) int32 {
	...
	w.L.Trace("syscall/ent", "pid", p.Pid, "index", idx, "name", syscalls.SyscallNames[idx], "a", a, "b", b, "c", c)
...
func (w *WasmInterface) syscall4(ctx context.Context, idx, a, b, c, d int32) int32 {
	...
	w.L.Trace("syscall/ent", "pid", p.Pid, "index", idx, "name", syscalls.SyscallNames[idx], "a", a, "b", b, "c", c, "d", d)
...
func (w *WasmInterface) syscall5(ctx context.Context, idx, a, b, c, d, e int32) int32 {
	...
	w.L.Trace("syscall/ent", "pid", p.Pid, "index", idx, "name", syscalls.SyscallNames[idx], "a", a, "b", b, "c", c, "d", d, "e", e)
...
func (w *WasmInterface) syscall6(ctx context.Context, idx, a, b, c, d, e, f int32) int32 {
	...
	w.L.Trace("syscall/ent", "pid", p.Pid, "index", idx, "name", syscalls.SyscallNames[idx], "a", a, "b", b, "c", c, "d", d, "e", e, "f", f)
...
func (w *WasmInterface) syscall(ctx context.Context, idx, addr int32) int32 {
	...
	w.L.Trace("syscall/ent", "pid", p.Pid, "ip", p.Vm.IP(), "index", idx, "name", syscalls.SyscallNames[idx], "req", args.Args)
